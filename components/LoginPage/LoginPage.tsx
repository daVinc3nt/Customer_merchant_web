...
const LoginPage = () => {
  ...
  return (
    <div className="fixed z-50 inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center">
      <div className= "h-2/5 w-11/12 sm:h-3/5 sm:w-5/6 lg:h-3/5 lg:w-5/6 xl:w-3/6 max-w-5xl bg-white relative overflow-hidden rounded-lg">
        <div
          id="signin"
        ...
        >
          ...
          >
            <div
              id="overlay-left"
              className={`w-1/2 h-full absolute flex justify-center items-center top-0 transform -translate-x-[20%] transition duration-700 ease-in-out ${
