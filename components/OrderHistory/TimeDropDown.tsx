...
const TimeDropDown = () => {
  ...
  return (
    <div className="relative p-4 z-20 ">
      <button onClick={() => setIsOpen(!isOpen)} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 sm:w-32 sm:h-10 rounded-full">
        <span>Thời gian</span>
      </button>
      {isOpen && (
        <div className="absolute mt-2 space-y-2 bg-white text-black border border-gray-200 rounded shadow-lg ">
          <div className='mx-2 my-2'>
            ...
            <label htmlFor="1hour"> 1 giờ trước</label>
          </div>
          <div className='mx-2 my-2'>
