...
const HistoryMenu = () => {
  ...
  return (
    <div className="h-[calc(100vh-3rem)] content-center overflow-y-hidden flex flex-col w-full rounded-sm">
      <div className="h-full items-center w-full bg-gray-200 left-0 right-0 overflow-y-scroll no-scrollbar rounded-sm">
        <section className="p-2 flex justify-center">
          <div className="container shadow-sm rounded-xl px-3 bg-white text-black">
