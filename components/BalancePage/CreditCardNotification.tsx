    ...
    >
      ...
      >
        <div className="relative items-center flex-col flex h-10 w-full border-b-2 border-gray-300">
          <div className="font-bold text-lg xs:text-xl"><FormattedMessage id="BalancePage.creditCardNotification.text1"/></div>
        ...
        <div className={`relative self-center w-full mt-6 pb-6 border-b-2 border-gray-300`}>
            ...
            <div className="relative flex flex-col p-4 h-32 rounded-t-2xl">
                <span className="text-xs xs:text-sm text-white font-bold"><FormattedMessage id="BalancePage.creditCardNotification.text2"/></span>
                ...
                <span className="absolute bottom-2 text-xs xs:text-sm grow text-white"><FormattedMessage id="BalancePage.creditCardNotification.text3"/> <b>₫{customerInfo.promotionalBalance}</b></span>
            </div>
          </motion.div>
        </div>
        <div className="rounded-lg mt-5 mb-1 py-1 text-buttonColorForm-text flex flex-col xs:flex-row">
            <span className="text-xs font-bold self-center xs:text-sm text-black xs:pl-2 sm:pl-6 xs:pr-10 whitespace-nowrap">
              <FormattedMessage id="BalancePage.creditCardNotification.text4"/>
            </span>
