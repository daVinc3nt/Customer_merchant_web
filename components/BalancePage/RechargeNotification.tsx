...
const RechargeNotification: React.FC<RechargeNotificationProps> = ({ onClose }) => {
  ...
  const validate = (values: number): string => {
    var errors: string = "";
    if (values < 10000) {
      errors = intl.formatMessage({ id: 'BalancePage.rechargeNotification.text3' });
    }
    if (!values) {
      errors = intl.formatMessage({ id: 'BalancePage.rechargeNotification.text6' });
    }
    return errors;
  };
    ...
    >
      ...
      >
        <div className="relative items-center flex-col flex h-10 w-full border-b-2 border-gray-300">
          <div className="font-bold text-xl"><FormattedMessage id="BalancePage.rechargeNotification.text1"/></div>
        ...
        <div className={`relative self-center w-full mt-6 pb-6 border-b-2 border-gray-300`}>
          ...
          >
            <FormattedMessage id="BalancePage.rechargeNotification.text2"/>
          </label>
        ...
        <div className="mt-2 pb-4 border-b-2 border-gray-300">
          <p className="pl-1"><FormattedMessage id="BalancePage.rechargeNotification.text4"/></p>
        ...
        <motion.button 
          ...
          <FormattedMessage id="BalancePage.rechargeNotification.text5"/>
        </motion.button>
      </motion.div>
    </motion.div>
  );
