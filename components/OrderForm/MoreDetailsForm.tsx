...
const MoreDetailsForm = () => {
    ...
    return <div className="flex flex-col h-5/6 w-full mt-8 bg-red-400 border-2 border-red-500 rounded-md overflow-y-hidden">  
    <h1 className="mt-2 text-2xl font-medium pl-6 text-white text-nowrap cursor-default" style={{ textShadow: '-1px -1px 0 red, 1px -1px 0 red, -1px 1px 0 black, 1px 1px 0 red' }}>Thêm chi tiết</h1>
